...
export const INITIAL_FEED_POSTS: FeedPost[] = [
  ...
  },
  {
    ...
    badgeColor: '#ef4444',
    description:
      'Братья Даффер обещают эпизоды масштаба голливудских блокбастеров. Вся банда Одиннадцать собирается вместе для решающей схватки с Векной. Русская озвучка выйдет в день релиза в VELORA.',
