...
export const PLAYER_SOURCES = [
  ...
  { label: 'EmbedSU',    base: 'https://embed.su/embed/movie/',          idType: 'imdb' },
...
export const PLAYER_SOURCES_TV = [
  ...
  { label: 'EmbedSU',    base: 'https://embed.su/embed/tv/',             idType: 'imdb' },
];
